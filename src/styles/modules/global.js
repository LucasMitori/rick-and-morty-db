...
const GlobalStyle = createGlobalStyle`
  ...
  :root{
    /* Colors */
    --color-primary: #44281D;
    --color-secondary: #E4A788;
    --color-tertiary: #F0E14A;
    --color-quartenary: #97CE4C;
    --color-quinternary: #E89AC7;
    ...
    --blur-effect-02: rgba( 31, 38, 135, 0.80 );
    --blur-effect-03: rgba( 2, 2, 2, 0.6 );
    ...
    --font-quinternary-creepster: 'Creepster';
